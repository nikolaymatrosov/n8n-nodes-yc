...
> **Решение проблем при обновлении:** Если обновление пакета через интерфейс n8n не работает корректно, используйте следующие шаги:
>
> 1. Удалить старую версию
> 2. Очистить папку `.n8n/nodes`
> 3. Перезапустить n8n
> 4. Установить новую версию
>
> Более надёжный способ обновления находится в разработке.
